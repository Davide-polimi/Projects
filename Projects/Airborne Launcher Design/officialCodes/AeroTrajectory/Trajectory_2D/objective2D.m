function deltaV = objective2D(x, Dt, Tf, r0, V0, m0, mDry, mPayload, rT, VT, Isp, thrust, launchLatitude, rocketDesign, nStages)
    g0 = 9.80665; % g0
    ...
    [deltaV] = EGuidance2S2D(r0, V0(1), V0(2), m, mDry, mPayload, thrust, Isp, guidancePara, rT, VT/rT, cs);
end